...
<script language='javascript'>
    ...
    function  jsf__pay( form )
    {
        ...
        {
            openwin = window.open( '/oneday/kcp/chk_plugin.html', 'chk_plugin', 'width=420, height=100, top=300, left=300' );
        }

        if ( MakePayMessage( form ) == true )
        {
            openwin = window.open( '/oneday/kcp/proc_win.html', 'proc_win', 'width=420, height=100, top=300, left=300' );
            return  true;
        }
        else
        {
...
<form name="order_info" action="/oneday/kcp/order_update.php" method="post" onSubmit="return jsf__pay(this)">
