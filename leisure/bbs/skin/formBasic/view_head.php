...
<table width="1012" border="0" cellspacing="0" cellpadding="0" style="layout:fixed;" align="center">
	<tr>
		<td colspan="10">
	...
	<tr>
		<td width="8%" height="28">&nbsp;<img src="<?=$skin_dir?>/image/view_t_star.gif"></td>
		<td align="left" colspan="5" >: <?=$star?></td>
	</tr>
	<?=$hide_star_end?>
	<?=$hide_upfile_start?>
	<tr>
