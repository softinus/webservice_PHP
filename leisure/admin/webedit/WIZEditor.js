			...
			//**	에디터 버튼 정의
				this.ButtonList	=	{
					//**				버튼 이름				:	 아이디					설명				클릭시 실행				이미지 경로
										...
										'justifyfull'			:	['JustifyFull',			'양쪽정렬',			'Editor_ACT(this.id)',		'icon_full.gif'],
										...
										'insertflash'			:	['InsertFlash',			'플래쉬 삽입',			'Editor_ACT(this.id)',		'icon_flash.gif'],
										'insertmovie'			:	['InsertMovie',			'동영상 삽입',			'Editor_ACT(this.id)',		'icon_movie.gif'],										
