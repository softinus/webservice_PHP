...
?>
			...
			<table border="0" cellspacing="0" cellpadding="2">
			  <tr>
			    ...
			    <td valign="bottom" class="tit">이용약관</td>
			    <td width="2"></td>
			    <td valign="bottom" class="tit_alt">이용약관을 설정합니다.</td>
			  </tr>
			</table>
      ...
      <input type="hidden" name="page" value="page_agreement.php">
       <tr> 
        ...
        <tr>
          <td align="center" class="t_name">이용약관 </td>
          <td class="t_value">
          <?
          $edit_height = "500";
