...
$page_type = "join";
$now_position = "<a href=/>Home</a> &gt; 회원가입 &gt; 정보입력";
		...
		<td align=center>
			...
			<tr>
				<td style="padding:0 0 5 0" valign=bottom>
					<table border=0 cellpadding=0 cellspacing=0 width=100%>
						<tr>
							<td><img src="/images/join_t_01.gif"></td>
							<td align=right><img src="/images/join_form01.gif"></td>
						</tr>
					</table>
		    </td>
		  </tr>
							...
							<td style="padding:5">
								<table border=0 cellpadding=0 cellspacing=0 width=100%>
									<tr height=28>
										...
										<td><input type=password name="passwd2" size=20 class="input"></td>
									</tr>
								</table>
							</td>
						</tr>
					    ...
					    <td style="padding:5">
								<table border=0 cellpadding=0 cellspacing=0 width=100%>
									<tr height=28>
										...
										<td><input type=text name="name" size=20 class="input" <? if($name!="") echo "value='".$name."' readonly"; ?>></td></tr>
									<tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									...
									<tr height=28>
										...
										<td>
											...
											<input type=password name="resno2" maxlength=7 size=8 class="input" <? if($resno2!="") echo "value='".$resno2."' readonly"; ?>>
										</td>
									</tr>
									<tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									<? } ?>
									...
									<tr height=70>
										...
										<td>
											...
											<input type=text name="hphone3" size=4 class="input"><br>문자 정보 서비스를 받으시겠습니까?&nbsp;
											<input name="resms" type="radio" value="Y" checked style="border:0px; background-color:transparent;">예&nbsp;
											<input name="resms" type="radio" value="N" style="border:0px; background-color:transparent;">아니요<br><font color="#317FB1">* 주문확인,배송 진행상황,알리미 등록,이벤트 공지 서비스 제공 해 드립니다.</font>
										</td>
									</tr>
									<tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									<? } ?>
									...
									<tr height=28>
										...
										<td>
											<input type=text name="fax" size=3 class="input"> -
											<input type=text name="fax2" size=4 class="input"> -
											<input type=text name="fax3" size=4 class="input">
										</td>
									</tr>
									<tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									<? } ?>
									...
									<tr height=70>
										...
										<td>
											<input type=text name="email" size=30 class="input"><br>이메일 서비스를 받으시겠습니까?&nbsp;
											<input name="reemail" type="radio" value="Y" checked style="border:0px; background-color:transparent;">예&nbsp;
											<input name="reemail" type="radio" value="N" style="border:0px; background-color:transparent;">아니요<br><font color="#317FB1">* 주문,결제,이벤트 정보제공, 단 유효하지 않은 이메일은 서비스 불가</font>
										</td>
									</tr>
									<tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									<? } ?>
									...
									<tr height=28>
										...
										<td><input type=text name="recom" size=20 class="input"></td>
									</tr>
								</table>
									...
									<table border=0 cellpadding=0 cellspacing=0 width=100%>
									  ...
									  <tr height=28>
											...
											<td>
											  ...
											  <input type=text name="birthday3" size=5 class="input">일&nbsp;&nbsp;
												...
												<input name="bgubun" value="M" type="radio" style="border:0px; background-color:transparent;">음력)
											</td>
										</tr>
									  <tr><td colspan=3 bgcolor=#eeeeee></td></tr>
										<? } ?>
									  ...
									  <tr height=28>
											...
											<td>
											  ...
											  <input name="marriage" value="N" type="radio" style="border:0px; background-color:transparent;">기혼
											</td>
										</tr>
									  <tr><td colspan=3 bgcolor=#eeeeee></td></tr>
										<? } ?>
						    ...
						    <td style="padding:5">
									<table border=0 cellpadding=0 cellspacing=0 width=100%>
									  ...
									  <tr height=28>
											...
											<td>
												<input name="com_num" type="text" class="input">
											</td>
										</tr>
									  <tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									  ...
									  <tr height=28>
											...
											<td>
												<input name="com_name" type="text" class="input">
											</td>
										</tr>
									  <tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									  ...
									  <tr height=28>
											...
											<td>
												<input name="com_owner" type="text" class="input">
											</td>
										</tr>
									  <tr><td colspan=3 bgcolor=#eeeeee></td></tr>
										...
										<tr height=28>
											...
											<td>
												...
												<input type=text name="com_post2" size=5 class="input">&nbsp;
										...
										<tr height=28>
											<td></td>
											<td></td>
											<td><input type=text name="com_address" size=80 class="input"></td>
										</tr>
									  <tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									  ...
									  <tr height=28>
											...
											<td>
												<input name="com_kind" type="text" class="input">
											</td>
										</tr>
									  <tr><td colspan=3 bgcolor=#eeeeee></td></tr>
									  ...
									  <tr height=28>
											...
											<td>
												<input name="com_class" type="text" class="input">
											</td>
										</tr>
									  <tr><td colspan=3 bgcolor=#eeeeee></td></tr>
						  ...
						  <tr>
						    <td style="padding:5">
									<table border=0 cellpadding=0 cellspacing=0 width=100%>
									  ...
									  <tr height=28>
											<td><img src="/images/blue_icon.gif"></td>
											<td width=100 align="left"><img src="/images/form_02_code.gif"></td>
											<td>
												<?=$spam_check?>
											</td>
										</tr>
