...
<?
	...
	$sql = "select wo.*, wb.amount, wp.prdname from wiz_dayorder wo, wiz_basket wb, wiz_dayproduct wp where wo.orderid = wb.orderid and wb.prdcode = wp.prdcode $status_sql 				$period_sql $searchopt_sql order by orderid desc";
	//echo $sql;
