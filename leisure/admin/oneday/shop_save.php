...
// 운영정보설정
	...
	$sql = "update wiz_operinfo set pay_method_day='$pay_tmp_day',
						number0='$number0',number1='$number1',number2='$number2',number3='$number3',number4='$number4',number5='$number5',number6='$number6',number7='$number7',number8='$number8',number9='$number9',button_buy='$button_buy',button_soldout='$button_soldout',
						timemsg='$timemsg',countmsg='$countmsg',sns='$sns_input'";
...
/*
	...
	mysql_query($sql) or error(mysql_error());
*/
	complete("운영정보 설정이 저장되었습니다.","oneday_oper.php");
