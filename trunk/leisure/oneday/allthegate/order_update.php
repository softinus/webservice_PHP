...
{
	// 주문정보
	$sql = "SELECT * FROM wiz_dayorder WHERE orderid = '$OrdNo'";
...
if($rSuccYn=="y"){
			...
			$sql = "select * from wiz_basket where orderid = '$rOrdNo'";
...
<!--
var openwin = window.open("/oneday/allthegate/AGS_progress.html","popup","width=300,height=160");
openwin.close();
-->
</script>
</head>
