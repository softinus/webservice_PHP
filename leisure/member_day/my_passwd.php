	...
	<tr>
		<td align=center style="padding:5 0 10 0">
			...
			<table border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td><a href="../member_day/my_shop.php"><img src="/images/myshop_m_01.gif" border=0></a></td>
					<td><a href="../member_day/my_order.php"><img src="/images/myshop_m_02.gif" border=0></a></td>
					<td><a href="../member_day/my_reserve.php"><img src="/images/myshop_m_03.gif" border=0></a></td>
					<td><a href="../member_day/my_qna.php"><img src="/images/myshop_m_04.gif" border=0></a></td>
					<td><a href="../member_day/my_wish.php"><img src="/images/myshop_m_05.gif" border=0></a></td>
					<td><a href="../member_day/my_info.php"><img src="/images/myshop_m_06.gif" border=0></a></td>
					<td><a href="../member_day/my_passwd.php"><img src="/images/myshop_m_o_07.gif" border=0></a></td>
					<td><a href="../member_day/my_out.php"><img src="/images/myshop_m_08.gif" border=0></a></td>
				</tr>
				<tr>
