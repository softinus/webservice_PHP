          	...
          	<tr>
          		<td bgcolor="<?=$stacolor?>" align="center">
			          ...
			          <? 		if($row->status == "OR"){ ?>
				          ...
				          <option>---------</option>
				          <option value="OY" <? if($row->status == "OY") echo "selected"; ?>>결제완료</option>
				          <option value="DR" <? if($row->status == "DR") echo "selected"; ?>>발급준비중</option>
				          <option value="DI" <? if($row->status == "DI") echo "selected"; ?>>발급처리</option>
				          <option value="DC" <? if($row->status == "DC") echo "selected"; ?>>발급완료</option>
				          <option value="OC" <? if($row->status == "OC") echo "selected"; ?>>주문취소</option>
				          <option>---------</option>
